...
const COPY = {
	pl: {
		...
		reduceMotionHint:
			"Spowalnia animacje CSS, przejscia, plynne przewijanie i ruch asystenta.",
		reset: "Reset",
	},
	en: {
		title: "Accessibility",
		...
		reduceMotionHint:
			"Slows CSS animations, transitions, smooth scrolling and assistant movement.",
		reset: "Reset",
	},
	fr: {
		title: "Accessibilite",
		...
		contrast: "Contraste",
		contrastHint:
			"Ajuste le contraste du texte, des bordures et des controles.",
		contrastNormal: "Normal",
	...
	de: {
		...
		reduceMotionHint:
			"Stoppt CSS-Animationen, Ubergange, sanftes Scrollen und die Bewegung des Assistenten.",
		reset: "Reset",
	},
};
			...
			<PopoverContent
				...
				<div className='space-y-3'>
					<div className='space-y-2 rounded-md border border-border bg-muted/30 p-3'>
						<div className='space-y-1'>
							<Label
								id='a11y-text-scale-label'
								className='text-sm font-semibold text-foreground'>
								{labels.textScale}: {settings.textScale}%
							</Label>
							<p
								id='a11y-text-scale-hint'
								className='text-xs leading-relaxed text-muted-foreground'>
						...
						<div className='flex items-center gap-2'>
							...
							<input
								...
								onChange={(event) =>
									updateTextScale(Number(event.target.value))
								}
						...
						<div
							...
							{contrastOptions.map((option) => (
								<Button
									key={option.value}
									variant={
										settings.contrast === option.value ? "default" : "outline"
									}
									size='sm'
									role='radio'
