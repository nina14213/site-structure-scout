...
export default function StartScreen({
  ...
  const hasSavedProgress =
    isSavedPlayer &&
    ((gameState?.levelsCompleted?.length ?? 0) > 0 || savedProgressValues.some((progress) => progress > 0));
  ...
  const levels = [
    ...
    },
    {
      ...
      icon: LinkIcon,
      color: "from-violet-100 via-purple-100 to-indigo-100 dark:from-violet-700 dark:via-purple-700 dark:to-indigo-800",
      hoverClass: "hover:from-violet-200 hover:via-purple-200 hover:to-indigo-200 dark:hover:brightness-110",
      textClass: "text-slate-900 dark:text-white",
    ...
    },
    {
      ...
      icon: Package,
      color: "from-teal-100 via-cyan-100 to-sky-100 dark:from-teal-700 dark:via-cyan-700 dark:to-sky-800",
      hoverClass: "hover:from-teal-200 hover:via-cyan-200 hover:to-sky-200 dark:hover:brightness-110",
      textClass: "text-slate-900 dark:text-white",
    ...
    },
    {
      ...
      icon: Search,
      color: "from-emerald-100 via-teal-100 to-cyan-100 dark:from-emerald-700 dark:via-teal-700 dark:to-cyan-800",
      hoverClass: "hover:from-emerald-200 hover:via-teal-200 hover:to-cyan-200 dark:hover:brightness-110",
      textClass: "text-slate-900 dark:text-white",
    ...
    },
    {
      ...
      icon: Shield,
      color: "from-rose-100 via-orange-100 to-amber-100 dark:from-red-700 dark:via-orange-700 dark:to-orange-800",
      hoverClass: "hover:from-rose-200 hover:via-orange-200 hover:to-amber-200 dark:hover:brightness-110",
      textClass: "text-slate-900 dark:text-white",
    ...
    <div className="min-h-screen p-4 md:p-8 bg-background dark:bg-gradient-to-br dark:from-slate-900 dark:via-indigo-950 dark:to-purple-950">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: -30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">{t("start.tagline")}</p>
                  ...
                  {levels.map((level, idx) => {
                    ...
                    return (
                      <motion.button
                        ...
                        whileHover={
                          unlocked && trimmedPlayerName
                            ? { scale: 1.05, transition: { duration: 0.08, ease: "easeOut" } }
                            : {}
                        }
                        whileTap={
                          unlocked && trimmedPlayerName
                            ? { scale: 0.98, transition: { duration: 0.05, ease: "easeOut" } }
                            : {}
                        }
                        data-task-button
                      ...
                      >
                        ...
                        <p id={`start-level-${level.id}-desc`} className="text-xs font-semibold opacity-95">
                          {t(level.descKey)}
                        </p>
