...
export const dwcTerms: Record<string, DwCTerm> = {
    ...
    basisOfRecord: {
        type: "controlled",
        required: true,
        allowedValues: ["PreservedSpecimen", "HumanObservation", "MachineObservation", "LivingSpecimen", "FossilSpecimen", "MaterialSample"],
...
Invasive species,3431,Ailanthus altissima,K. Słupecka,15-05-2025,1,individual,"Dębina municipal forest in Poznań, Poland",52.369327,16.925402,WGS84,Forest near railroad
Invasive species,6405,Ailanthus altissima,K. Słupecka,17-06-2025,1,individual,"Marii Skłodowskiej-Curie Park, Poznań, Poland",52.3935228,16.918701,WGS84,Park`;

// ISO Country Codes (wybrane)
export const isoCodes = [
    "PL", "DE", "CZ", "SK", "UA", "BY", "LT", "RU", "SE", "NO", "FI", "DK",
    "GB", "FR", "ES", "IT", "AT", "CH", "NL", "BE", "US", "CA", "AU", "BR"
];
