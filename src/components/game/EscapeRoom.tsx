...
const puzzles: Puzzle[] = [
  ...
  },
  {
    ...
    description: "Ten gatunek inwazyjny pochodzi z Chin i nazywany jest 'Drzewem Niebios' (z malajskiego 'ailanto'). Ma charakterystyczny nieprzyjemny zapach liści i pierzaste liście o długości 40-60 cm. Łaciński epitet gatunkowy 'altissima' oznacza 'najwyższy'. Podaj pełną nazwę łacińską tego gatunku.",
    hint: "Rodzaj: Ailanthus (od 'ailanto' = drzewo niebios). Epitet: altissima (najwyższy).",
    clue: "Format: Rodzaj + spacja + epitet gatunkowy",
